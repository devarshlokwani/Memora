...
export function CourseSettings({
  ...
  return (
    <div className="mt-8 rounded-card border border-rule bg-card">
    ...
    <div>
      <label className="block">
        ...
        <input
          ...
          className="mt-1.5 w-full max-w-md rounded-md border border-rule bg-paper px-3 py-2.5 text-[0.95rem] text-ink outline-none focus:border-ink"
        />
      </label>
      ...
      <button
        ...
        className="mt-4 rounded-md bg-ink px-4 py-2 text-sm font-medium text-paper hover:opacity-90 disabled:opacity-50"
      >
  ...
  return (
    <div>
      ...
      <button
        ...
        className="mt-4 rounded-md border border-ink px-4 py-2 text-sm font-medium text-ink hover:bg-paper"
      >
        Choose files
      </button>
      <input
      ...
      <button
        ...
        className="mt-4 block rounded-md bg-ink px-4 py-2 text-sm font-medium text-paper hover:opacity-90 disabled:opacity-40"
      >
    ...
    <div>
      ...
      <div className="mt-4 flex gap-2.5">
        <button
          ...
          onClick={remove}
          disabled={busy}
          className="rounded-md bg-wrong px-4 py-2 text-sm font-medium text-white hover:opacity-90 disabled:opacity-50"
        >
